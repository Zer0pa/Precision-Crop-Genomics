...
**Visibility:** Public repository; this policy applies to the public research/PRD staging surface and any future implementation work.

## Scope

This document binds the data and artifact lifecycle for the Zer0pa Precision Crop Genomics workstream. It is consumed by the license-stamping ETL service (Phase-0 deliverable per `docs/planning/PRD-OUTLINE-FOR-OPERATOR-REVIEW.md`), by every sub-agent ingesting external data, and by every model training run that produces commercializable artifacts.
